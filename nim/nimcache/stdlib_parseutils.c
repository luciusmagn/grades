...
/* Command for C compiler:
   gcc -c  -w -pthread  -I/usr/lib/nim -o /root/remedias/nim/nimcache/stdlib_parseutils.o /root/remedias/nim/nimcache/stdlib_parseutils.c */
...
N_LIB_PRIVATE N_NIMCALL(NI, parseSaturatedNatural_heAOnV8CAiOgwhPKbfpRgA)(NimStringDesc* s, NI* b, NI start) {
	...
	nimln_(284, "parseutils.nim");
	{
		...
		i = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_12);
	}
	LA3_: ;
	nimln_(285, "parseutils.nim");
	{
		...
		(*b) = ((NI) 0);
		{
			...
			while (1) {
				...
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TM_vI9aZNKIcImom6dDyKXW1ZA_13 = subInt(((NU8)(s->data[i])), ((NI) 48));
				c = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_13);
				nimln_(289, "parseutils.nim");
				{
					...
					TM_vI9aZNKIcImom6dDyKXW1ZA_14 = subInt(((NI) IL64(9223372036854775807)), c);
					TM_vI9aZNKIcImom6dDyKXW1ZA_15 = divInt((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_14), ((NI) 10));
					if (!((*b) <= (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_15))) goto LA13_;
					nimln_(290, "parseutils.nim");
					TM_vI9aZNKIcImom6dDyKXW1ZA_16 = mulInt((*b), ((NI) 10));
					TM_vI9aZNKIcImom6dDyKXW1ZA_17 = addInt((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_16), c);
					(*b) = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_17);
				}
				goto LA11_;
				LA13_: ;
				{
				...
				TM_vI9aZNKIcImom6dDyKXW1ZA_18 = addInt(i, ((NI) 1));
				i = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_18);
				{
		...
		TM_vI9aZNKIcImom6dDyKXW1ZA_20 = subInt(i, start);
		result = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_20);
	}
	LA7_: ;
	popFrame();
	return result;
