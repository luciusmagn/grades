...
/* Command for C compiler:
   gcc -c  -w -pthread  -I/usr/lib/nim -o /root/remedias/nim/nimcache/stdlib_posix.o /root/remedias/nim/nimcache/stdlib_posix.c */
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, WIFSIGNALED_jey9c9a5UxiJK7PlQ0lLtE0Q_2)(int s) {
	...
	result = (((NI8) 0) < (NI8)((NU8)(((NI8) ((NI32)(TM_mJPr4mHlDfNAl9asG6X7NFA_2)))) >> (NU64)(((NI) 1))));
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(int, WEXITSTATUS_9cr9a9bc3d9byCALaQhU9aObNDw_2)(int s) {
	...
	result = (int)0;
	nimln_(610, "posix_linux_amd64.nim");
