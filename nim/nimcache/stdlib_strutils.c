...
/* Command for C compiler:
   gcc -c  -w -pthread  -I/usr/lib/nim -o /root/remedias/nim/nimcache/stdlib_strutils.o /root/remedias/nim/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_22, "\012", 1);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_23, "invalid format string", 21);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_24, "0123456789ABCDEF", 16);
...
appendString(result, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_22));
				}
				LA8_: ;
				{
					NI j;
...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString_61EJWW6vRISEo9a8gt0tusw)(void) {
	...
	(*e).Sup.Sup.m_type = (&NTI_Gi06FkNeykJn7mrqRZYrkA_);
	T1_ = (NimStringDesc*)0;
	T1_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_23));
	...
	result = mnewString(((NI) (len)));
	{
		...
		res = colontmp_;
		{
			while (1) {
				...
				j = res;
				result->data[j] = ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_24)->data[(NI64)(n & IL64(15))];
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuNormalize)(NimStringDesc* s) {
	...
	j = ((NI) 0);
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_25 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_25);
		nimln_(2045, "system.nim");
		res = ((NI) 0);
		{
			nimln_(2046, "system.nim");
			while (1) {
				...
				nimln_(393, "strutils.nim");
				{
					...
					if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
					TM_JGc9b9bh2D3nTdUR7TGyq8aA_26 = addInt(((NU8)(s->data[i])), ((NI) 32));
					result->data[j] = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_26), ((NI) 0), ((NI) 255)))));
					nimln_(395, "strutils.nim");
					TM_JGc9b9bh2D3nTdUR7TGyq8aA_27 = addInt(j, ((NI) 1));
					j = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_27);
				}
				goto LA4_;
				LA6_: ;
				{
					...
					TM_JGc9b9bh2D3nTdUR7TGyq8aA_28 = addInt(j, ((NI) 1));
					j = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_28);
				}
				goto LA4_;
				LA9_: ;
				LA4_: ;
				nimln_(2048, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_29 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_29);
			} LA3: ;
		}
	}
